...
@section('content')
  <x-header>
    ...
    <x-slot name="title">Create New Course</x-slot>
  </x-header>
  ...
  <div class="page-body">
    <div class="container-xl">
      <div class="row row-deck row-cards">
        <div class="col-12">
          <form class="card" action="{{ route('admin.courses.store') }}" method="POST">
            @csrf
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <label class="form-label required">
                    <i class="ti ti-section me-1"></i> Section
                  </label>
